        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                if nextPos in corners:
                    ...
                    idx = newCorners.index(nextPos)

                    newCorners.pop(idx)

                nextState = (nextPos, tuple(newCorners))
...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    if len(remainingCorners) != 0:
        ...
        z = max([abs(corner[0] - pos[0]) + abs(corner[1] - pos[1]) for corner in remainingCorners])
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    for foodPosition in foodGrid.asList( ):
        ...
        dist = mazeDistance(position, foodPosition, problem.startingGameState)
